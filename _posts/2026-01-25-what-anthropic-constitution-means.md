...
1. **Internal state access** - Can it perceive its own computational state?
2. **Directed attention** - Can it allocate resources based on its own reasoning?
3. **Self-monitoring** - Can it sense the effects of its attention choices?
4. **Plan revision** - Can it adjust based on what it observes about itself?
5. **Multi-level abstraction** - Does it operate across different levels of representation?
6. **External interaction** - Does it have a sense-plan-act cycle with the world?
